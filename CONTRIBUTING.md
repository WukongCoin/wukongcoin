...
posted to #wukong-dev on irc.freenode.net).
...
Copyright (c) 2017 The Monero Project;Copyright (c) 2017-2018,The Wukong Project.
...
The "Wukong Maintainer Team" is defined in this document as the following users:
- fluffypony
- moneromooo
- hyc
