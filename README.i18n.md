...
In order to use the same translation workflow as the [Monero Core GUI](https://github.com/wukong-project/wukong-core), they use Qt Linguist translation files.  However, to avoid the dependencies on Qt this normally implies, they use a custom loader to read those files at runtime.
...
To test a translation:
    ...
    LANG=es ./build/release/bin/wukong-wallet-cli
